...
public class TileScriptedDoorClassVisitor extends ClassVisitor {
    public TileScriptedDoorClassVisitor(int api, ClassVisitor cv) {
        super(api, cv);
    }
    ...
    public MethodVisitor visitMethod(int access, String name, String desc, String signature, String[] exceptions) {
        if (!f && "noticeString".equals(name)) {
            f = true;
            return new TileScriptedDoorClassVisitor.MethodVisitorImpl(super.visitMethod(access, name, desc, signature, exceptions));
    ...
    private static class MethodVisitorImpl extends MethodVisitor {
        ...
        public void visitMethodInsn(int opcode, String owner, String name, String desc, boolean itf) {
            if (!f && "com/google/common/base/MoreObjects$ToStringHelper".equals(owner) && "toString".equals(name)) {
                ...
                mv.visitMethodInsn(INVOKEVIRTUAL, "noppes/npcs/blocks/tiles/TileScriptedDoor", d ? "getWorld" : "func_145831_w", "()Lnet/minecraft/world/World;", false);
